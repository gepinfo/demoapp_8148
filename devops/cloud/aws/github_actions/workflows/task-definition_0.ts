module.exports = {
    ...
    "containerDefinitions": [
        {
            "name": "studentdetails-8148",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-demoapp-8148-studentdetails:latest`,
